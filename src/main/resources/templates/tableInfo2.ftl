...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office"
    ...
    <Worksheet ss:Name="Sheet0">
         <#list list as list0>
             <#if (list?size>0)>
        <Table ss:ExpandedColumnCount="5" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="13.5">
            <Column ss:Index="1" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="120" ss:Span="4"/>
            <Row ss:StyleID="s50" ss:Height="25">
                <Cell ss:StyleID="s54" ss:MergeAcross="4">
